...
#SBATCH --job-name=interface_relax_test_ortho
#SBATCH --nodes=1     
#SBATCH --ntasks=1                   
#SBATCH --cpus-per-task=100  # adjust to max   
#SBATCH --mem-per-cpu=1G      
#SBATCH --time=1-00:00:00 
#SBATCH --output=/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/interface_relax/logs/%x_%A.out
#SBATCH --error=/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/interface_relax/logs/%x_%A.err
