...
def average_replicates(csv_file, outdir="/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/benchmark_structures/csv_files"):
    """
    ...
    df["mutation"] = df["description"].str.replace(r"_\d+\.pdb$", "", regex=True)
