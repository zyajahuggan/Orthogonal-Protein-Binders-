...
def main():
    ...
    parser.add_argument("--wt_pdb", type=str, required=False,
                        default='/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/benchmark_structures/inputs/trimmedint1KI1cdc3QBV.pdb')
    ...
    for i in range(1, args.nstruct + 1):
        jobs.append(("wt", os.path.join(args.out_wt, f"relaxed_cross_{i}.pdb")))
        jobs.append(("ortho", os.path.join(args.out_ortho, f"relaxed_cross_{i}.pdb")))
