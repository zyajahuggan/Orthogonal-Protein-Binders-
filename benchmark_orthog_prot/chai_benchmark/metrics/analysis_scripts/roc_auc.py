...
leaderboard.to_csv(results_dir / f"chai_auc_{project}_leaderboard.csv", index=False)
...
plt.xlabel("AUC")
plt.title("AUC by Metric — Chai")
plt.gca().invert_yaxis()
plt.tight_layout()
plt.savefig(barplot_dir / f"chai_auc_bar_{project}.png", dpi=300)
plt.close()
