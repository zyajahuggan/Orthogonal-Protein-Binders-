...
for df, _, project, _, results_dir in iter_datasets():
    cog_hbonds = df.loc[df["cognate_status"] == 1, "interface_interface_hbonds"]
    non_cog_hbonds = df.loc[df["cognate_status"] == 0, "interface_interface_hbonds"]
