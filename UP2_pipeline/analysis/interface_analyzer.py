...
if __name__ == "__main__":
    main(
        pdb_dir="/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/UP2_pipeline/output/relaxed_wtreceptorup2ligand_4ref_pdbs",
        wt_pdb="/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/UP2_pipeline/input/5repeats_5_wt/relaxed_wtreceptorup2ligand_4.pdb",
        monomer_chain="Y",
        out_sc="/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/UP2_pipeline/score_files/wtreceptorup2ligand_4ref.sc"
    )
