...
def main():
    ...
    parser.add_argument("--wt_pdb", type=str, required=False,
                        default='/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/UP2_pipeline/input/WTReceptorUP2Ligand.pdb')
    parser.add_argument("--ortho_pdb", type=str, required=False,
                        default='/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/UP2_pipeline/input/UP2ReceptorUP2Ligand.pdb')
    parser.add_argument("--out_wt", type=str, required=False,
                        default='/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/UP2_pipeline/input/5repeats_5_wt',
                        help="Output dir for WT")
    parser.add_argument("--out_ortho", type=str, required=False,
                        default='/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/UP2_pipeline/input/5repeats_5_up2',
    ...
    for i in range(1, args.nstruct + 1):
        jobs.append(("wt", os.path.join(args.out_wt, f"relaxed_wtreceptorup2ligand_{i}.pdb")))
        jobs.append(("ortho", os.path.join(args.out_ortho, f"relaxed_up2receptorup2ligand_{i}.pdb")))
