...
def parse_args():
    ...
    parser.add_argument("--in_pdb", type=str,
                        default='/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/UP2_pipeline/input/5repeats_5_up2/relaxed_up2receptorup2ligand_4.pdb') #average pdb 
    parser.add_argument("--in_csv", type=str,
                        default='/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/UP2_pipeline/pipelines/mutant_list.csv')
    parser.add_argument("--out_dir", type=str, default="/scratch/jgray21/zyhuggan/Orthogonal-Protein-Binders-/UP2_pipeline/output/relaxed_up2receptorup2ligand_4ref_pdbs" ,help="Output directory.")
